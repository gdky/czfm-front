...
import {Table, Row, Col, Button, Icon, notification, Alert,Upload,} from 'antd'
...
const list = React.createClass({
    ...
    getDefaultProps(){
        return {
            ...
            pageSize: 10,
            //数据来源api
            apiUrl: config.URI_API_FRAMEWORK  + `/recgl`,
            addUrl: config.URI_API_FRAMEWORK  + `/recgl/recAdd`,
            //初始搜索条件
            defaultWhere:{},
            //栏目名称
            title:'语音管理'
    ...
    render(){
        ...
        const {title,scrollx,keyCol,columns,addUrl} = this.props;
        let toolbar = <ToolBar>
            <ButtonGroup>
